...
int main() {
	ofstream myfile;
	myfile.open("out-2.txt");
	int n = 10;
	const double h = 1600;
	const double cp = 386.00; //from www.iun.edu/~cpanhd/C101webnotes/matter-and-energy/specificheat.html
	const double d = 8960;//from https://en.wikipedia.org/wiki/Copper
